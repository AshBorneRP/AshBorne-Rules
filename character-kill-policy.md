...
If you wish to forcefully end another player's story, you must open a CK Request ticket. Senior Staff will review the narrative buildup and respond within 48 hours. 
...
* **Deferred:** Staff requires more context or an additional 24 hours to review the history.
*(If staff fails to respond within 48 hours, the ticket will be automatically escalated to top leadership).*
...
1. **Submit Evidence:** The killer must upload video evidence (showing the buildup, the execution, and the immediate aftermath) into their open CK ticket. Staff will review the footage to ensure RP quality and officially log the death.
2. **No Appeals:** Once a CK is approved and executed, it is final. 
3. **Start Fresh:** The victim must create a completely brand-new character with a new name, voice, and personality. Your new character retains zero memories, assets, or base codes from their past life.
4. **The 30-Day Cooldown:** To prevent "revenge" characters, your new character may not join, ally with, or associate with your previous faction for 30 real-life days (unless explicitly exempted by staff in a ticket). Attempting to silently infiltrate your old storylines will result in severe administrative action.

### 🏃‍♂️ 6.5 Evading a Character Kill
If a CK has been approved against your character and you attempt to dodge it, the consequences will be severe.
Evasion includes:
...
<div style="display: flex; justify-content: space-between; font-family: 'Cinzel', serif; font-size: 14px; letter-spacing: 1px; margin-bottom: 40px;">
    <a href="hostile-roleplay.html" style="text-decoration: none; color: #888;">⬅ PREVIOUS: HOSTILE & KOS</a>
    <a href="base-building.html" style="text-decoration: none; color: #ff6600;">NEXT: BASE BUILDING ➔</a>
</div>
