...
These are not loose guidelines or polite requests—they are the strict behavioral requirements that allow our server to function. If you are unwilling or unable to meet these standards, you will not succeed in this community. 

### 🎙️ 2.1 Constant Immersion (Stay In-Character)
...
* **OOC Emergencies:** If an absolute out-of-character (OOC) emergency arises, use the proximity text chat with brackets `((like this))` and keep it as brief as possible. 
* Staff actively monitor the server. If you are caught silently playing during active scenarios or consistently breaking immersion, you will be penalized. Protect the immersion of the world fiercely.
...
We encourage dark, complex, and morally gray storytelling, but this is never an excuse for OOC toxicity, laziness, or real-world harm.
...
### 🗣️ 2.9 Primary Language Requirement
...
<div style="display: flex; justify-content: space-between; font-family: 'Cinzel', serif; font-size: 14px; letter-spacing: 1px; margin-bottom: 40px;">
    <a href="community-values.html" style="text-decoration: none; color: #888;">⬅ PREVIOUS: VALUES</a>
    <a href="roleplay-guidelines.html" style="text-decoration: none; color: #ff6600;">NEXT: RP GUIDELINES ➔</a>
</div>
